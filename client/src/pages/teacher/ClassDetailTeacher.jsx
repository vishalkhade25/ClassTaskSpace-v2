    ...
    <div className="flex-1 py-8 px-4 sm:px-6 lg:px-8 max-w-4xl w-full mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200/80 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Create and track assignments, due dates, and student submissions.
          </p>
        </div>
        <button
      ...
      {!loading && assignments.length === 0 && !searchTerm && (
        <div className="bg-white border border-dashed border-slate-300 rounded-2xl p-10 text-center max-w-lg mx-auto my-8">
          ...
          <h3 className="text-lg font-bold text-slate-900">No assignments created yet</h3>
          <p className="text-sm text-slate-500 mt-1 max-w-sm mx-auto mb-6">
            Get started by posting your first assignment and setting a deadline for your students.
          </p>
          <button
            onClick={() => navigate(`/teacher/class/${classId}/assignment/create`)}
